...
public final class Bluebit {
    ...
    /* ISSC Proprietary */
    public final static UUID SERVICE_ISSC_PROPRIETARY  = UUID.fromString("6e400001-b5a3-f393-e0a9-e50e24dcca9e");
    ...
    public final static UUID CHR_ISSC_TRANS_TX         = UUID.fromString("6e400003-b5a3-f393-e0a9-e50e24dcca9e");
    public final static UUID CHR_ISSC_TRANS_RX         = UUID.fromString("6e400002-b5a3-f393-e0a9-e50e24dcca9e");
    ...
    public final static UUID DES_CLIENT_CHR_CONFIG2 = Util.uuidFromStr("2902");

 ...
 *
 * Updated usage:
 *    MyPreferences prefs = MyPreferences.getPrefs(this, MY_APP_NAME, Context.MODE_PRIVATE);
 *    //to get data
...
public class MyPreferences implements SharedPreferences {
    ...
    public final static String PREF_NAME="co.kr.bnr.bnrtrackerv";

    public final static String SAVED_DATA_10_MINUTE = "SAVED_DATA_10_MINUTE";//10분동안의 데이터
    public final static String IS_CHECK_ENABLE = "IS_CHECK_ENABLE";//서비스에서 체크 진행중이냐
    public final static String IS_FIRST_RUN = "IS_FIRST_RUN";//앱실행이 처음임
    public final static String LAST_UPDATE_TIME = "LAST_UPDATE_TIME";//서비스에서 마지막으로 서비스 실행한 시간. 이걸 로그파일 이름으로 할거다
   ...
   //Set to true if a decryption error was detected
     ...
     */
    public MyPreferences(Context context, SharedPreferences delegate) {
        this.delegate = delegate;
        this.context = context;
        //updated thanks to help from bkhall on github
        MyPreferences.setNewKey(Secure.getString(context.getContentResolver(), Secure.ANDROID_ID));
        MyPreferences.setNewSalt(Secure.getString(context.getContentResolver(), Secure.ANDROID_ID));
    }
     ...
     * @return
     */
    public synchronized static MyPreferences getPrefs(Context c, int contextMode) {
        ...
        MyPreferences prefs = new MyPreferences(c.getApplicationContext(), c.getApplicationContext().getSharedPreferences(PREF_NAME, contextMode) );
    	return prefs;
    }
    ...
    public class Editor implements SharedPreferences.Editor {
        ...
        public Editor() {
            this.delegate = MyPreferences.this.delegate.edit();
        }

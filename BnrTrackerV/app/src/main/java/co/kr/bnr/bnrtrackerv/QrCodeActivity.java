...
import co.kr.bnr.bnrtrackerv.decode.DecodeImageCallback;
import co.kr.bnr.bnrtrackerv.decode.DecodeImageThread;
import co.kr.bnr.bnrtrackerv.view.QrCodeFinderView;
...
import co.kr.bnr.bnrtrackerv.camera.CameraManager;
import co.kr.bnr.bnrtrackerv.decode.DecodeManager;
import co.kr.bnr.bnrtrackerv.decode.InactivityTimer;
...
public class QrCodeActivity extends Activity implements Callback, OnClickListener {
    ...
    public DecodeImageCallback mDecodeImageCallback = new DecodeImageCallback() {
        @Override
